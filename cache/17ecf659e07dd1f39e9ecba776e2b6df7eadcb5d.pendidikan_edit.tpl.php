...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_56f9ea044e8f41_62832005',
  'cache_lifetime' => 120,
),true);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_56f9ea044e8f41_62832005')) {
function content_56f9ea044e8f41_62832005 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
 	...
 	<div class="page-container">
		...
		<!-- Page content -->
	 	<div class="page-content">
			...
			<input type="hidden" name="id_pen" value="4">
	                	...
	                	<div class="row">
	                		<div class="col-md-6">
	                			<div class="form-group">
                                    ...
                                    <input type="text" name="nama_pendidikan" value="SMEA" placeholder="Nama Pendidikan" class="form-control" required>
	                			</div>
	                		</div>
