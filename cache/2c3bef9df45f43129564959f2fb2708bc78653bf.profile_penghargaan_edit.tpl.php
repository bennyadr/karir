...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_56cea53da6ec06_57376285',
  'cache_lifetime' => 120,
),true);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_56cea53da6ec06_57376285')) {
function content_56cea53da6ec06_57376285 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<b>Notice</b>:  Undefined index: idpeg in <b>C:\xampp\htdocs\sip\templates_c\2c3bef9df45f43129564959f2fb2708bc78653bf_0.file.profile_penghargaan_edit.tpl.cache.php</b> on line <b>156</b><br />
<br />
<b>Notice</b>:  Trying to get property of non-object in <b>C:\xampp\htdocs\sip\templates_c\2c3bef9df45f43129564959f2fb2708bc78653bf_0.file.profile_penghargaan_edit.tpl.cache.php</b> on line <b>156</b><br />
">
                      ...
                      <div class="col-md-6">
                        ...
                        <tr>
                            <td width="200"> <label>Nama Penghargaan :</label> </td>
                             <td><input type="text" name="penghargaan" placeholder="Nama Penghargaan" class="form-control" value="aaaaa">
                                <br /> </td>
                          </tr>
                          <tr>
                            <td width="200"> <label>Pemberi Penghargaan :</label> </td>
                            <td><input type="text" name="pemberi_penghargaan" placeholder="Pemberi Penghargaan" class="form-control" value="aaaa"><br /> </td>
                          </tr>
                          <tr>
                          <td width="200"><label>Tanggal Pemberian :</label></td>
                                    <td><input type="text" name="tgl_penghargaan" class="form-control input-sm" id="tgl_penghargaan" placeholder="dd/mm/yyyy" value="11/02/2016"><br /></td>
                                    </tr>
                          <tr>
