<?php
/*%%SmartyHeaderCode:2979757051cd1ccf1f1_48566830%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2e3758d2e8fe782e735fb53a1b94e26d30a498ea' => 
    array (
      0 => 'C:\\xampp\\htdocs\\karir\\templates\\eselon.tpl',
      1 => 1459140439,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '2979757051cd1ccf1f1_48566830',
  'tpl_function' => 
  array (
  ),
  'variables' => 
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_57051cd2d674a2_33363100',
  'cache_lifetime' => 120,
),true);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_57051cd2d674a2_33363100')) {
function content_57051cd2d674a2_33363100 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
	...
	<!-- Page container -->
 	<div class="page-container">
			...
			<div class="sidebar-content">
				...
				<ul class="navigation">				
					...
					<ul>
							...
							<li  class="active" ><a href="eselon.php">Eselon</a></li>
	 	...
	 	<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Daftar Eselon<small>Informasi Eselon Pegawai</small></h3>
				</div>
			...
			<!-- Table inside panel body -->
			    ...
			    <div class="panel panel-success">
			                <div class="panel-heading"><h6 class="panel-title"><i class="icon-table2"></i>Tabel Eselon</h6></div>
			                <table id="example" class="table table-striped table-bordered table-hover" style="width:100%; ">
              <thead>
              <tr>
	  			  <th style="width:1%;text-align:center;">No</th>
				  <th style="width:5%;text-align:center;">Eselon</th>
        ...
        <TD VALIGN=TOP align=LEFT>II/a</TD>
		<TD VALIGN=TOP style="text-align:center;">
        ...
        <TD VALIGN=TOP align=LEFT>II/b</TD>
		<TD VALIGN=TOP style="text-align:center;">
        ...
        <TD VALIGN=TOP align=LEFT>II/c</TD>
		<TD VALIGN=TOP style="text-align:center;">
        ...
        <TD VALIGN=TOP align=LEFT>III/c</TD>
		<TD VALIGN=TOP style="text-align:center;">
        ...
        <TD VALIGN=TOP align=LEFT>III/d</TD>
		<TD VALIGN=TOP style="text-align:center;">
        ...
        <TD VALIGN=TOP align=LEFT>IV/c</TD>
		<TD VALIGN=TOP style="text-align:center;">
        ...
        <TD VALIGN=TOP align=LEFT>IV/d</TD>
		<TD VALIGN=TOP style="text-align:center;">
		<a href="?action=edit&id=16" class="btn btn-primary btn-icon btn-xs tip" title="Edit" data-original-title="Edit"><i class="icon-pencil"></i></a>
		<a href="?action=del&id=16" onclick="return confirm('Anda Yakin?');" class="btn btn-danger btn-icon btn-xs tip" title="Delete" data-original-title="Delete"><i class="icon-remove2"></i></a>
		</TD>
        <TR align="center">
        <TD VALIGN=TOP align=center>17</TD>
        <TD VALIGN=TOP align=LEFT>V/a</TD>
		<TD VALIGN=TOP style="text-align:center;">
		<a href="?action=edit&id=18" class="btn btn-primary btn-icon btn-xs tip" title="Edit" data-original-title="Edit"><i class="icon-pencil"></i></a>
		<a href="?action=del&id=18" onclick="return confirm('Anda Yakin?');" class="btn btn-danger btn-icon btn-xs tip" title="Delete" data-original-title="Delete"><i class="icon-remove2"></i></a>
		</TD>
    	</tbody></table>
				        </div>
