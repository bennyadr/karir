<?php
/*%%SmartyHeaderCode:7577570495403cfe02_44418400%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '389ef85914c51ee9a04cd310a778ab0f4c5af34a' => 
    array (
      0 => 'C:\\xampp\\htdocs\\karir\\templates\\kompetensi_edit.tpl',
      1 => 1459745609,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '7577570495403cfe02_44418400',
  'tpl_function' => 
  array (
  ),
  'variables' => 
  array (
    'id' => 0,
    'kelompoktingkatjbt_opt' => 0,
    'kompetensi_opt' => 0,
    'level' => 0,
  ),
  'has_nocache_code' => false,
  'version' => '3.1.27',
  'unifunc' => 'content_57049541463927_87845542',
  'cache_lifetime' => 120,
),true);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_57049541463927_87845542')) {
function content_57049541463927_87845542 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
		...
		<div class="sidebar">
			<div class="sidebar-content">
				...
				<ul class="navigation">				
					...
					<ul>
							<li  class="active" ><a href="kompetensi.php">Kompetensi Jabatan</a></li>
...
<b>Notice</b>:  Undefined index: id in <b>C:\xampp\htdocs\karir\templates_c\389ef85914c51ee9a04cd310a778ab0f4c5af34a_0.file.kompetensi_edit.tpl.cache.php</b> on line <b>74</b><br />
<br />
<b>Notice</b>:  Trying to get property of non-object in <b>C:\xampp\htdocs\karir\templates_c\389ef85914c51ee9a04cd310a778ab0f4c5af34a_0.file.kompetensi_edit.tpl.cache.php</b> on line <b>74</b><br />
">
	                	...
	                	<div class="row">
	                 		<div class="col-md-8">
                                ...
                                <option value=''>--Pilih--</option>
                                                                <option value="1" >OS3</option>
                                                                <option value="2" >OS4</option>
                                                                <option value="3" >ON3</option>
                                                                <option value="4" >ON4</option>
                                                                </select>
	                			</div>
	                		</div>
	                		<div class="col-md-8">
                                ...
                                <option value=''>--Pilih--</option>
                                                                <option value="1" >Orientasi Pelayanan</option>
                                                                <option value="2" >Integritas</option>
                                                                <option value="3" >Komitmen</option>
                                                                <option value="4" >Disiplin</option>
                                                                <option value="5" >Kerjasama</option>
                                                                <option value="6" >Kepemimpinan</option>
                                                                </select>
	                			</div>
	                		</div>
	                		<div class="col-md-8">
	                			<div class="form-group">
									<label>Level  :</label>
                                    <input type="number" name="level" placeholder="Level" class="form-control" value="3" required>
	                			</div>
	                		</div>
