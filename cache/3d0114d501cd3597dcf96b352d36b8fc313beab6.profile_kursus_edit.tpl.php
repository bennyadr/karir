...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_56cec3a5057454_37296398',
  'cache_lifetime' => 120,
),true);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_56cec3a5057454_37296398')) {
function content_56cec3a5057454_37296398 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
                  ...
                  <div class="panel-body">
	                	<div class="row">
                          ...
                          <td width="200"> <label>Kursus :</label> </td>
                            <td><input type="text" name="kursus" placeholder="Kursus" class="form-control" value="asdsads"><br /> </td>
                            </tr>

                            <tr>
                          <td width="200"> <label>Instansi :</label> </td>
                            <td><input type="text" name="instansi" placeholder="Tempat" class="form-control" value="asdads"><br /> </td>
                            </tr>
                          ...
                          <td width="200"> <label>Tahun :</label> </td>
                            <td><input type="text" name="tahun" placeholder="tahun" class="form-control" value="2013"><br /> </td>
                            </tr>
                            <tr>
