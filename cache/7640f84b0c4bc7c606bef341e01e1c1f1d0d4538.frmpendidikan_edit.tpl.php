...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_56c422a9a765d6_72665414',
  'cache_lifetime' => 120,
),true);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_56c422a9a765d6_72665414')) {
function content_56c422a9a765d6_72665414 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
	                	...
	                	<div class="row">
                          ...
                          <tr>
                            ...
                            <td><select name=tingkat class="form-control">
                                <option value="<br />
<b>Notice</b>:  Undefined index:  in <b>C:\xampp\htdocs\sip\templates_c\7640f84b0c4bc7c606bef341e01e1c1f1d0d4538_0.file.frmpendidikan_edit.tpl.cache.php</b> on line <b>128</b><br />
" selected="selected">Pilih</option>
                          ...
                          <td width="200"> <label>Sekolah/Universitas :</label> </td>
                            <td><input type="text" name="sekolah" placeholder="Sekolah/Universitas" class="form-control" value="CKI"><br /> </td>
                            </tr>

                             <tr>
                             <td width="200"> <label>Tahun Masuk :</label> </td>
                            <td><input type="text" NAME="tahun_awal" id="thn_awal" placeholder="yyyy" class="form-control" value="2012"> <br/></td>
                            <td width="50" align="center">s/d <br /></td>
                            <td width="200"><input type="text" NAME="tahun_akhir" id="thn_akhir" placeholder="yyyy" class="form-control" value="2016"><br /> </td>
                             </tr>

                            <tr>
                          <td width="200"> <label>Tempat :</label> </td>
                            <td><input type="text" name="tempat" placeholder="Tempat" class="form-control" value="Jakarta"><br /> </td>
                            </tr>

                            <tr>
                          <td width="200"> <label>Jurusan :</label> </td>
                            <td><input type="text" name="jurusan" placeholder="Jurusan" class="form-control" value="Teknik Informatika"><br /> </td>
                            </tr>
                             <tr>
                          <td width="200"> <label>Gelar :</label> </td>
                            <td><input type="text" name="gelar" placeholder="Gelar" class="form-control" value="qwqwqw"><br /> </td>
                            </tr>
                            <tr>
                          <td width="200"> <label>IPK/Nilai :</label> </td>
                            <td><input type="text" name="ipk" placeholder="IPK/Nilai" class="form-control" value="3,70"><br /> </td>
                            </tr>
                            <tr>
