<?php
/*%%SmartyHeaderCode:13220570dc64b07e137_16990734%%*/
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '13220570dc64b07e137_16990734',
  'tpl_function' => 
  array (
  ),
  'variables' => 
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_570dc64bdea473_44512149',
  'cache_lifetime' => 120,
),true);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_570dc64bdea473_44512149')) {
function content_570dc64bdea473_44512149 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
			...
			<div class="sidebar-content">
				...
				<ul class="navigation">				
					...
					<ul>
							...
							<li  class="active" ><a href="arah.php">Arah Karir</a></li>
					</ul>
					</li>
...
<div class="breadcrumb-line">
				<ul class="breadcrumb">
					<li><a href="index.php?action=showmenu">Home</a></li>
					 					 					 					 					 					 					 					 					 					 <li class="active">Arah Karir</li>					 					 					 					 					 					 					 					 				</ul>
        ...
        <TD VALIGN=TOP align=LEFT>OS5</TD>
        ...
        <TD VALIGN=TOP align=LEFT>GS1</TD>
        <TD VALIGN=TOP align=LEFT>OS4</TD>
        <TD VALIGN=TOP align=LEFT>OUT</TD>
		<TD VALIGN=TOP style="text-align:center;">
        ...
        <TD VALIGN=TOP align=LEFT>GS3</TD>
        <TD VALIGN=TOP align=LEFT>KF10</TD>
        <TD VALIGN=TOP align=LEFT>OUT</TD>
		<TD VALIGN=TOP style="text-align:center;">
