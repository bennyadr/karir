...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_56cbe02ee49aa2_07172965',
  'cache_lifetime' => 120,
),true);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_56cbe02ee49aa2_07172965')) {
function content_56cbe02ee49aa2_07172965 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="col-md-11">
             <div class="form-group">
                ...
                <select name="idperiode" required class="form-control">
					          <option value='<br />
<b>Notice</b>:  Undefined index:  in <b>C:\xampp\htdocs\sip\templates_c\7948ea440ab3b3a87c981e15b47fbe7345bba721_0.file.potongan_edit.tpl.cache.php</b> on line <b>138</b><br />
' selected="selected">Pilih</option>
					            					        ...
					            					        <option value="042015" selected=selected>042015</option>
              ...
              <div class="form-group">
                ...
                <select name="pegawai" required class="form-control">
						<option value='<br />
<b>Notice</b>:  Undefined index: detail in <b>C:\xampp\htdocs\sip\templates_c\7948ea440ab3b3a87c981e15b47fbe7345bba721_0.file.potongan_edit.tpl.cache.php</b> on line <b>175</b><br />
<br />
<b>Notice</b>:  Undefined index:  in <b>C:\xampp\htdocs\sip\templates_c\7948ea440ab3b3a87c981e15b47fbe7345bba721_0.file.potongan_edit.tpl.cache.php</b> on line <b>175</b><br />
' selected="selected">Pilih</option>
													...
													<option value="15049512067" selected=selected>ASRI MAULIA RAHMA</option>
               ...
               <div class="form-group">
                <label>PPH 21 :</label>
                <input type="text" name="pph21" id="pph21" placeholder="PPH 21" class="form-control" value="0">
              </div>

              <div class="form-group">
                <label>BPJS Ketenagakerjaan :</label> 
                <input type="text" name="jht" id="jht" placeholder="BPJS Ketenagakerjaan" class="form-control" value="0">
              </div>
              <div class="form-group">
                <label>Pinjaman :</label>
                <input type="text" name="pinjaman" id="pinjaman" placeholder="Pinjaman" class="form-control" value="0">
              </div>

              <div class="form-group">
                <label>Potongan Lain :</label> 
                <input type="text" name="potlain" id="potlain" placeholder="Potongan Lain" class="form-control" value="0">
              </div>
              <div class="form-group">
                <label>Ket. Pendapatan Lain :</label> 
                <input type="text" name="ketpotlain" placeholder="Ket. Pendapatan Lain" class="form-control" value="">
              </div>
