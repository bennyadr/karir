...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_56fa74c5dc24e4_45651171',
  'cache_lifetime' => 120,
),true);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_56fa74c5dc24e4_45651171')) {
function content_56fa74c5dc24e4_45651171 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
	                	...
	                	<div class="row">
	                		<div class="col-md-6">
	                			<div class="form-group">
                                    ...
                                    <input type="text" name="Nama_KelompokTingkatJbt" placeholder="Nama Kelompk" class="form-control" value="" required>
	                			</div>
	                		</div>
	                		<div class="col-md-6">
	                		<div class="form-group">
									<label>Nama Kelompok 2 :</label>
                                    <input type="text" name="Nama_KelompokTingkatJbt2" placeholder="Nama Kelompok" class="form-control" value="" required>
	                			</div>
	                		</div>
	                		<div class="col-md-6">
	                		<div class="form-group">
