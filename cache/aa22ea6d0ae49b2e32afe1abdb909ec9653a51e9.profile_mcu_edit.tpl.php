...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_56ceade5cadc43_85602960',
  'cache_lifetime' => 120,
),true);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_56ceade5cadc43_85602960')) {
function content_56ceade5cadc43_85602960 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
                  ...
                  <div class="panel-body">
	                	<div class="row">
                          ...
                          <td width="200"><label>Tanggal Pemeriksaan :</label></td>
                                    <td><input type="text" name="tgl_pemeriksaan" class="form-control input-sm" id="tgl_pemeriksaan" placeholder="dd/mm/yyyy" value=""><br /></td>
                                    </tr>
                          <tr>
                            <td width="200"> <label>Hasil Pemeriksaan :</label> </td>
                            <td><textarea type="text" name="hasil" placeholder="Hasil Pemeriksaan" class="form-control" value=""></textarea><br /> </td>
                          </tr>
                          <tr>
                            ...
                            <td><input type="text" name="no_sertifikat" placeholder="No Sertifikat  " class="form-control" value=""><br /> </td>
                          </tr>

                          <tr>
                            <td width="200"> <label>Tenaga Medis :</label> </td>
                            <td><input type="text" name="tenaga_medis" placeholder="Hasil Pemeriksaan" class="form-control" value=""><br /> </td>
                          </tr>
                          <tr>
                            <td width="200"> <label>Catatan Kesehatan :</label> </td>
                            <td><textarea type="text" name="catatan" placeholder="Catatan Kesehatan" class="form-control" value=""></textarea><br /> </td>
                          </tr>
                          <tr>
                          <td width="200"><label>Tanggal Dari :</label></td>
                                    <td><input type="text" name="tgl_dari" class="form-control input-sm" id="tgl_dari" placeholder="dd/mm/yyyy" value=""><br /></td>
                                    </tr>
                          
                          <tr>
                          <td width="200"><label>Tanggal Sampai :</label></td>
                                    <td><input type="text" name="tgl_sampai" class="form-control input-sm" id="tgl_sampai" placeholder="dd/mm/yyyy" value=""><br /></td>
                                    </tr>
                          <tr>
