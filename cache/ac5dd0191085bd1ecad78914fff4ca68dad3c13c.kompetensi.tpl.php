...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_570ca5192b2bd5_27895139',
  'cache_lifetime' => 120,
),true);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_570ca5192b2bd5_27895139')) {
function content_570ca5192b2bd5_27895139 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="breadcrumb-line">
				<ul class="breadcrumb">
					<li><a href="index.php?action=showmenu">Home</a></li>
					 					 					 					 					 					 					 					 					 					 					 <li class="active">Kompetensi Jabatan</li>					 					 					 					 					 					 					 				</ul>
        ...
        <TD VALIGN=TOP align=LEFT>OS3</TD>
        ...
        <TD VALIGN=TOP align=LEFT>OS4</TD>
        <TD VALIGN=TOP align=LEFT></TD>
        <TD VALIGN=TOP align=LEFT>5</TD>
		<TD VALIGN=TOP style="text-align:center;">
        ...
        <TD VALIGN=TOP align=LEFT>ON4</TD>
        <TD VALIGN=TOP align=LEFT></TD>
        <TD VALIGN=TOP align=LEFT>5</TD>
		<TD VALIGN=TOP style="text-align:center;">
