...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_57051cd438c3a2_06265497',
  'cache_lifetime' => 120,
),true);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_57051cd438c3a2_06265497')) {
function content_57051cd438c3a2_06265497 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
	...
	<!-- Page container -->
 	<div class="page-container">
			...
			<div class="sidebar-content">
				...
				<ul class="navigation">				
					...
					<ul>
							...
							<li  class="active" ><a href="unitkerja.php">Unit Kerja</a></li>
        ...
        <TD VALIGN=TOP align=LEFT>DITJEN</TD>
        ...
        <TD VALIGN=TOP align=LEFT>SETDITJEN</TD>
		<TD VALIGN=TOP style="text-align:center;">
        ...
        <TD VALIGN=TOP align=LEFT>Dit. Pemb. TK/SD</TD>
		<TD VALIGN=TOP style="text-align:center;">
        ...
        <TD VALIGN=TOP align=LEFT>Dit. Pemb. SMP</TD>
		<TD VALIGN=TOP style="text-align:center;">
        ...
        <TD VALIGN=TOP align=LEFT>Dit. Pemb. SMA</TD>
		<TD VALIGN=TOP style="text-align:center;">
        ...
        <TD VALIGN=TOP align=LEFT>Dit. Pemb. SMK</TD>
		<TD VALIGN=TOP style="text-align:center;">
        ...
        <TD VALIGN=TOP align=LEFT>Dit. Pemb. SLB</TD>
		<TD VALIGN=TOP style="text-align:center;">
