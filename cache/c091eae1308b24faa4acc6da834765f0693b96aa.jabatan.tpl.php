<?php
/*%%SmartyHeaderCode:3061857051cd584c9d2_48521723%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c091eae1308b24faa4acc6da834765f0693b96aa' => 
    array (
      0 => 'C:\\xampp\\htdocs\\karir\\templates\\jabatan.tpl',
      1 => 1459223102,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '3061857051cd584c9d2_48521723',
  'tpl_function' => 
  array (
  ),
  'variables' => 
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_57051cd686ea44_34133979',
  'cache_lifetime' => 120,
),true);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_57051cd686ea44_34133979')) {
function content_57051cd686ea44_34133979 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
	...
	<!-- Page container -->
 	<div class="page-container">
	 	...
	 	<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Daftar Jabatan<small>Informasi Jabatan Pegawai</small></h3>
				</div>
			...
			<!-- Table inside panel body -->
			    ...
			    <div class="panel panel-success">
			                <div class="panel-heading"><h6 class="panel-title"><i class="icon-table2"></i>Tabel Jabatan</h6></div>
        ...
        <TD VALIGN=TOP align=LEFT>KEPALA DIVISI PORTOFOLIO INVESTASI I</TD>
		<TD VALIGN=TOP style="text-align:center;">
        ...
        <TD VALIGN=TOP align=LEFT>KEPALA SUBDIV. PENGEMBANGAN INST. & PENG. I</TD>
		<TD VALIGN=TOP style="text-align:center;">
        ...
        <TD VALIGN=TOP align=LEFT>KEPALA SUBDIVISI PEMBIAYAAN DAN HUKUM I</TD>
		<TD VALIGN=TOP style="text-align:center;">
        ...
        <TD VALIGN=TOP align=LEFT>KEPALA SUBDIV. PENILAIAN KELAYAKAN & MNJ. RISIKO I</TD>
		<TD VALIGN=TOP style="text-align:center;">
        ...
        <TD VALIGN=TOP align=LEFT>KEPALA SUBDIVISI ANGGARAN</TD>
		<TD VALIGN=TOP style="text-align:center;">
        ...
        <TD VALIGN=TOP align=LEFT>KEPALA SUBDIVISI UMUM</TD>
		<TD VALIGN=TOP style="text-align:center;">
        ...
        <TD VALIGN=TOP align=LEFT>KEPALA SUBDIVISI AKUNTANSI DAN PELAPORAN</TD>
		<TD VALIGN=TOP style="text-align:center;">
        ...
        <TD VALIGN=TOP align=LEFT>PELAKSANA SUBDIVISI ANGGARAN</TD>
		<TD VALIGN=TOP style="text-align:center;">
        ...
        <TD VALIGN=TOP align=LEFT>PELAKSANA SUBDIVISI PKMR</TD>
		<TD VALIGN=TOP style="text-align:center;">
        ...
        <TD VALIGN=TOP align=LEFT>PELAKSANA SUBDIVISI P & H</TD>
		<TD VALIGN=TOP style="text-align:center;">
        ...
        <TD VALIGN=TOP align=LEFT>PELAKSANA SUBDIVISI PI & P</TD>
		<TD VALIGN=TOP style="text-align:center;">
        ...
        <TD VALIGN=TOP align=LEFT>PELAKSANA SUBDIVISI AKLAP</TD>
		<TD VALIGN=TOP style="text-align:center;">
		<a href="?action=edit&id=15" class="btn btn-primary btn-icon btn-xs tip" title="Edit" data-original-title="Edit"><i class="icon-pencil"></i></a>
		<a href="?action=del&id=15" onclick="return confirm('Anda Yakin?');" class="btn btn-danger btn-icon btn-xs tip" title="Delete" data-original-title="Delete"><i class="icon-remove2"></i></a>
		</TD>
        <TR align="center">
        <TD VALIGN=TOP align=center>16</TD>
        <TD VALIGN=TOP align=LEFT>-</TD>
		<TD VALIGN=TOP style="text-align:center;">
		<a href="?action=edit&id=39" class="btn btn-primary btn-icon btn-xs tip" title="Edit" data-original-title="Edit"><i class="icon-pencil"></i></a>
		<a href="?action=del&id=39" onclick="return confirm('Anda Yakin?');" class="btn btn-danger btn-icon btn-xs tip" title="Delete" data-original-title="Delete"><i class="icon-remove2"></i></a>
		</TD>
        <TR align="center">
        <TD VALIGN=TOP align=center>17</TD>
        <TD VALIGN=TOP align=LEFT>Pelaksana Umum</TD>
		<TD VALIGN=TOP style="text-align:center;">
		<a href="?action=edit&id=40" class="btn btn-primary btn-icon btn-xs tip" title="Edit" data-original-title="Edit"><i class="icon-pencil"></i></a>
		<a href="?action=del&id=40" onclick="return confirm('Anda Yakin?');" class="btn btn-danger btn-icon btn-xs tip" title="Delete" data-original-title="Delete"><i class="icon-remove2"></i></a>
		</TD>
    	</tbody></table>
				        </div>
