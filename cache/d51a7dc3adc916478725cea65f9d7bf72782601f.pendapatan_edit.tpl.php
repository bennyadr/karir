...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_56ca931ef21816_54178691',
  'cache_lifetime' => 120,
),true);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_56ca931ef21816_54178691')) {
function content_56ca931ef21816_54178691 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<form name="pendapatan_form" class="" action="?action=editProcess" method="POST" ENCTYPE="multipart/form-data"><input type="hidden" name="id" value="635">
            ...
            <div class="col-md-11">
             <div class="form-group">
                ...
                <select name="idperiode" required class="form-control">
					          <option value='<br />
<b>Notice</b>:  Undefined index:  in <b>C:\xampp\htdocs\sip\templates_c\d51a7dc3adc916478725cea65f9d7bf72782601f_0.file.pendapatan_edit.tpl.cache.php</b> on line <b>137</b><br />
' selected="selected">Pilih</option>
					            					        ...
					            					        <option value="082015" selected=selected>082015</option>
              ...
              <div class="form-group">
                ...
                <select name="pegawai" required class="form-control">
						<option value='<br />
<b>Notice</b>:  Undefined index: detail in <b>C:\xampp\htdocs\sip\templates_c\d51a7dc3adc916478725cea65f9d7bf72782601f_0.file.pendapatan_edit.tpl.cache.php</b> on line <b>174</b><br />
<br />
<b>Notice</b>:  Undefined index:  in <b>C:\xampp\htdocs\sip\templates_c\d51a7dc3adc916478725cea65f9d7bf72782601f_0.file.pendapatan_edit.tpl.cache.php</b> on line <b>174</b><br />
' selected="selected">Pilih</option>
													...
													<option value="11212121212" selected=selected>NUFRI WILIS</option>
             ...
             <div class="form-group">
                ...
                <input type="text" name="transport" id="transport" placeholder="Transport & Meal" class="form-control" value="1111111">
              </div>

              <div class="form-group">
                <label>Tunjangan Kehadiran :</label> 
                <input type="text" name="thadir" id="thadir" placeholder="Tunjangan Kehadiran" class="form-control" value="1111111">
              </div>
              <div class="form-group">
                <label>Tunjangan Jabatan :</label>
                <input type="text" name="tjabatan" id="tjabatan" placeholder="Tunjangan Jabatan" class="form-control" value="1111111">
              </div>

              <div class="form-group">
                <label>Tunjangan Lain :</label> 
                <input type="text" name="tlain" id="tlain" placeholder="Tunjangan Lain" class="form-control" value="1111111">
              </div>
              <div class="form-group">
                <label>Ket. Pendapatan Lain :</label> 
                <input type="text" name="ket_lain" placeholder="Ket. Pendapatan Lain" class="form-control" value="">
              </div>
