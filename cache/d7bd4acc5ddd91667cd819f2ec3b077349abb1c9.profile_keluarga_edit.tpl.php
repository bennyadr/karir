...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_56cec36555d3f3_94114919',
  'cache_lifetime' => 120,
),true);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_56cec36555d3f3_94114919')) {
function content_56cec36555d3f3_94114919 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
                  ...
                  <div class="panel-body">
	                	<div class="row">
                          ...
                          <td width="200"><label>Tanggal Lahir :</label></td>
                                    <td><input type="text" name="tgl_lahir" class="form-control input-sm" id="tgl_lahir" placeholder="dd/mm/yyyy" value=""><br /></td>
                                    </tr>
                          <tr>
                            <td width="200"> <label>Nama Anggota Keluarga :</label> </td>
                            <td><input type="text" name="nama" placeholder="Nama Anggota Keluarga" class="form-control" value=""><br /> </td>
                          </tr>
                          <tr>
