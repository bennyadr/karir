...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_56ceadcf2fc924_91092007',
  'cache_lifetime' => 120,
),true);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_56ceadcf2fc924_91092007')) {
function content_56ceadcf2fc924_91092007 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
			    ...
			    <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="perusahaan" placeholder="Nama Perusahaan" class="form-control" value=""><br /> </td>
                          </tr>
                          <tr>
                            <td width="200"> <label>Jabatan :</label> </td>
                            <td><input type="text" name="jabatan" placeholder="Jabatan" class="form-control" value=""><br /> </td>
                          </tr>
	                				<tr>
                          <td width="200"><label>Tanggal Mulai :</label></td>
                                    <td><input type="text" name="tgl_mulai" class="form-control input-sm" id="tgl_mulai" placeholder="dd/mm/yyyy" value=""><br /></td>
                                    </tr>
                          <tr>
                          <tr>
                          <td width="200"><label>Tanggal Akhir :</label></td>
                                    <td><input type="text" name="tgl_akhir" class="form-control input-sm" id="tgl_akhir" placeholder="dd/mm/yyyy" value=""><br /></td>
                                    </tr>
                          <tr>
                            <td width="200"> <label>Alamat Perusahaan :</label> </td>
                            <td><input type="text" name="alamat" placeholder="Alamat Perusahaan" class="form-control" value=""><br /> </td>
                          </tr>

                          <tr>
                            <td width="200"> <label>Deskripsi Pekerjaan :</label> </td>
                            <td><input type="text" name="deskripsi" placeholder="Deskripsi Pekerjaan" class="form-control" value=""><br /> </td>
                          </tr>
