...
$id = $_GET['id'];
$sql = "SELECT a.id,NIK,nama,nama_jabatan,divisi,no_rek,bank,npwp,email,telpon_rumah,keterangan,pathfoto,telpon_kantor,no_asuransi_kesehatan,case when status_p = 'A' then 'Aktif' when sex = 'T' then 'Tidak Aktif' else 'Belum Ada Status' end as status_p,
	...
	left join tab_pendidikan e on a.pend_darat = e.id_pen where a.id='$id'";
...
<page backtop="14mm" backbottom="14mm" backleft="10mm" backright="10mm" style="font-size: 12pt">
	...
	<div style="text-align: center; width: 100%;">
        <br>
        <img src="img/logo.png" alt="Logo" style="width: 100mm">
        <br>
    </div>
...
<?php // untuk mendapatkan data pendidikan
    ...
    <TD VALIGN=TOP align=justify style="width: 30%; border: solid 1px silver; text-align:justify;"><?php echo $rs_pendidikan['sekolah_univ']; ?></TD>
...
<?php // untuk mendapatkan data kursus
      $sql_kursus="SELECT * FROM dat_kursus where id_peg = '$kode' order by id asc";
...
<?php // untuk mendapatkan data pekerjaan
      $sql_pekerjaan="SELECT * FROM dat_mutasi_jabatan where id_peg = '$kode' order by id asc";
...
<?php // untuk mendapatkan data organisasi
      $sql_orga="SELECT * FROM dat_organisasi where id_peg = '$kode' order by id asc";
...
<?php // untuk mendapatkan data keluarga
      $sql_keluarga="SELECT *,date_format(tgl_lahir,'%d %M %Y') as tgllahir FROM dat_keluarga where id_peg = '$kode' order by id asc";
    ...
    <TD VALIGN=TOP align=justify style="width: 61%; border: solid 1px silver;"><?phpphp echo $rs_keluarga['nama']; ?></TD>
...
<?php // untuk mendapatkan data kesehatan
      $sql_kesehatan="SELECT * FROM dat_kesehatan where id_peg = '$kode' order by id asc";
...
<?php // untuk mendapatkan data penghargaan
      $sql_peng="SELECT *,date_format(tgl_penghargaan,'%d %M %Y') as tglpenghargaan FROM dat_penghargaan where id_peg = '$kode' order by id asc";
...
<?php // untuk mendapatkan data hukuman
      $sql_sanksi="SELECT *, date_format(tgl_sanksi,'%d %M %Y') as tglsanksi FROM dat_sanksi where id_peg = '$kode' order by id asc";
...
<?php // untuk mendapatkan data mcu
      $sql_mcu="SELECT *,date_format(tgl_pemeriksaan,'%d %M %Y') as tglpemeriksaan FROM dat_mcu where id_peg = '$kode' order by id asc";
    ...
    <TD VALIGN=TOP align=center style="width: 26%; border: solid 1px silver;"><? echo $rs_mcu['tenaga_medis']; ?></TD>
