          ...
          <div class="row">
            ...
            <div class="form-group">
               ...
               <div class="form-group">
                ...
                <input type="text" autocomplete="off" onkeyup="autoComplete();" id='inputan' placeholder="Autosuggest Nama Karyawan" class="form-control" value="{$nama}" required>
                <input type='hidden' id='nama' name='nama' value="{$idpeg}">
                <div id="hasil"></div>
              </div>

              <div class="form-group">
                <label>NIK :</label>
                <input type="text" name="nip" id="nip" class="form-control" value="{$nik}" />
                </div>

                <div class="form-group">
                <label>Jabatan :</label>
                <input type="text" name="jabatan" id="jabatan" class="form-control" value="{$jabatan}" />
                </div>
                ...
                <input type="text" name="no_telp" id="no_telp" class="form-control" placeholder="No Telp/HP" value="{$notelp}" />
                </div>

                <div class="form-group">
                <label>Alamat Pemohon :</label> 
                <textarea type="text" name="alamat" placeholder="Alamat Pemohon" class="form-control" required>{$alamat}</textarea>
                </div>
                ...
                <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <input type="text" autocomplete="off" onkeyup="autoComplete2();" id='inputan2' placeholder="Autosuggest Nama Atasan" class="form-control" value="{$namaats}" required>
                          <input type='hidden' id='nama2' name='nama2' value="{$idpeg2}">
                      <div id="hasil2"></div>
                      </div>

                      <div class="form-group">
                <label>Jabatan Atasan/Penanggung Jawab :</label>
                <input type="text" name="jabatanats" id="jabatanats" class="form-control" value="{$jabatanats}" />
                </div>

                <div class="form-group"><label>Tanggal Mulai :</label>
                                      <input type="text" name="tgl_mulai" class="form-control input-sm" id="tgl_mulai" placeholder="dd/mm/yyyy" value="{$tgl_mulai}" required>
                                    </div>
                ...
                <input type="text" name="jmlhari" id="jmlhari" placeholder="Hari Kerja" class="form-control" / value="{$jmlhari}" required></div></div>
                              </div>

                 <div class="form-group">
                <label>Alasan Pemohon :</label> 
                <textarea type="text" name="alasan" placeholder="Alasan Pemohon" class="form-control" required>{$alasan}</textarea>
                </div>
