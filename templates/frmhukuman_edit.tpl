...
{/literal}
  ...
  <div class="page-container">
    ...
    <div class="page-content">
      ...
      <form name="myForm" class="" action="?action=HukumanEditProses" method="POST" ENCTYPE="multipart/form-data">
                      ...
                      <div class="col-md-6">
                        ...
                        <tr>
                            <td width="200"> <label>Nama Hukuman :</label> </td>
                             <td><input type="text" name="hukuman" placeholder="Nama Hukuman" class="form-control" value="{$hukuman}">
                                <br /> </td>
                          </tr>
                          <tr>
                            <td width="200"> <label>Pemberi Hukuman :</label> </td>
                            <td><input type="text" name="pemberi_hukuman" placeholder="Pemberi Hukuman" class="form-control" value="{$pemberi_hukuman}"><br /> </td>
                          </tr>
                          <tr>
                          <td width="200"><label>Tanggal Pemberian :</label></td>
                                    <td><input type="text" name="tgl_sanksi" class="form-control input-sm" id="tgl_sanksi" placeholder="dd/mm/yyyy" value="{$tgl_sanksi}"><br /></td>
                                    </tr>
                                    <tr>
                            <td width="200"> <label>No. Surat :</label> </td>
                            <td><input type="text" name="no_sanksi" placeholder="No Surat" class="form-control" value="{$no_sanksi}"><br /> </td>
                          </tr>
                          <tr>
