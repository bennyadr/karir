	...
	<!-- Page container -->
 	<div class="page-container">
      ...
      <br />
			...
			<form name="myForm" class="" action="?action=KesehatanEditProses" method="POST" ENCTYPE="multipart/form-data">
                  ...
                  <div class="panel-body">
	                	<div class="row">
                          ...
                          <td width="200"> <label>Penyakit :</label> </td>
                            <td><input type="text" name="penyakit" placeholder="Nama Penyakit" class="form-control" value="{$penyakit}"><br /> </td>
                            </tr>
