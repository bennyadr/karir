	...
	<!-- Page container -->
 	<div class="page-container">
      ...
      <br />
			...
			<form name="myForm" class="" action="?action=PekerjaanEditProses" method="POST" ENCTYPE="multipart/form-data">
			    ...
			    <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="perusahaan" placeholder="Nama Perusahaan" class="form-control" value="{$perusahaan}"><br /> </td>
                          </tr>
                          <tr>
                            <td width="200"> <label>Jabatan :</label> </td>
                            <td><input type="text" name="jabatan" placeholder="Jabatan" class="form-control" value="{$jabatan}"><br /> </td>
                          </tr>
	                				<tr>
                          <td width="200"><label>Tanggal Mulai :</label></td>
                                    <td><input type="text" name="tgl_mulai" class="form-control input-sm" id="tgl_mulai" placeholder="dd/mm/yyyy" value="{$tgl_mulai}"><br /></td>
                                    </tr>
                          <tr>
                          <tr>
                          <td width="200"><label>Tanggal Akhir :</label></td>
                                    <td><input type="text" name="tgl_akhir" class="form-control input-sm" id="tgl_akhir" placeholder="dd/mm/yyyy" value="{$tgl_akhir}"><br /></td>
                                    </tr>
                          <tr>
                            <td width="200"> <label>Alamat Perusahaan :</label> </td>
                            <td><input type="text" name="alamat" placeholder="Alamat Perusahaan" class="form-control" value="{$alamat}"><br /> </td>
                          </tr>

                          <tr>
                            <td width="200"> <label>Deskripsi Pekerjaan :</label> </td>
                            <td><input type="text" name="deskripsi" placeholder="Deskripsi Pekerjaan" class="form-control" value="{$deskripsi}"><br /> </td>
                          </tr>
