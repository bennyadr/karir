	...
	<!-- Page container -->
 	<div class="page-container">
      ...
      <br />
			...
			<form name="myForm" class="" action="?action=OrganisasiEditProses" method="POST" ENCTYPE="multipart/form-data">
                  ...
                  <div class="panel-body">
	                	<div class="row">
                          ...
                          <td width="200"> <label>Nama Organisasi :</label> </td>
                            <td><input type="text" name="organisasi" placeholder="Nama Organisaasi" class="form-control" value="{$organisasi}"><br /> </td>
                            </tr>
                          ...
                          <td width="200"> <label>Tahun :</label> </td>
                            <td><input type="text" name="tahun" placeholder="Tahun" class="form-control" value="{$tahun}"><br /> </td>
                            </tr>
                        </table>
                      </div>
                    </div> 
