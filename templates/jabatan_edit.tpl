	                	...
	                	<div class="row">
	                		<div class="col-md-6">
	                			<div class="form-group">
                                    ...
                                    <input type="text" name="jabatan_code" placeholder="Kode Jabatan" class="form-control" value="{$jabatan_code}" required>
	                			</div>
	                		</div>
	                		...
	                		<div class="form-group">
                                    ...
                                    <input type="text" name="jabatan_name" placeholder="Nama Jabatan" class="form-control" value="{$jabatan_name}" required>
	                			</div>
	                		</div>
