{include file="header.tpl"}
    ...
    <TR align="center">
        ...
        <TD VALIGN=TOP align=LEFT>{$pos[detail].kelompokjbt}</TD>
        <TD VALIGN=TOP align=CENTER>{$pos[detail].Nama_KelompokTingkatJbt}</TD>
        <TD VALIGN=TOP align=CENTER>{$pos[detail].tingkatjbt}</TD>
