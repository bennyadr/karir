        ...
        <div class="panel-body">
          <div class="row">
            ...
            <div class="form-group">
                <label>Judul :</label>
                <input type="text" name="posName" id="posName" class="form-control" placeholder="Judul" value="{$posName}" />
                </div>
                <div class="form-group">
                <label>Isi Berita :</label> 
                <textarea type="text" name="berita" class="editor" required>{$berita}</textarea>
                </div>
                </div>
                </div>
