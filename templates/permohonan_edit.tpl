              ...
              <div class="form-group">
                ...
                <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <input type='hidden' id='nama2' name='idpegats' value="{$idpegats}">
                      <div id="hasil2"></div>
                      </div>
                ...
                <div class="form-group"><label>Tanggal Mulai :</label>
                                      <input type="text" name="tglmulai" class="form-control input-sm" id="tgl_mulai" placeholder="dd/mm/yyyy" value="{$tglmulai}" required>
                                    </div>
