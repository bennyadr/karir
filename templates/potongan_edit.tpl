            ...
            <div class="col-md-11">
             <div class="form-group">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                <label>PPH 21 :</label>
                <input type="text" name="pph21" id="pph21" placeholder="PPH 21" class="form-control" value="{$pph21}">
              </div>

              <div class="form-group">
                <label>BPJS Ketenagakerjaan :</label> 
                <input type="text" name="jht" id="jht" placeholder="BPJS Ketenagakerjaan" class="form-control" value="{$jht}">
              </div>
              <div class="form-group">
                <label>Pinjaman :</label>
                <input type="text" name="pinjaman" id="pinjaman" placeholder="Pinjaman" class="form-control" value="{$pinjaman}">
              </div>

              <div class="form-group">
                <label>Potongan Lain :</label> 
                <input type="text" name="potlain" id="potlain" placeholder="Potongan Lain" class="form-control" value="{$potlain}">
              </div>
              <div class="form-group">
                <label>Ket. Pendapatan Lain :</label> 
                <input type="text" name="ketpotlain" placeholder="Ket. Pendapatan Lain" class="form-control" value="{$ketpotlain}">
              </div>
