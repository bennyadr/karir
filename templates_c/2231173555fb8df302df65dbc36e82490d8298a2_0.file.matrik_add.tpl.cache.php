<?php /* Smarty version 3.1.27, created on 2016-04-01 05:27:07
         compiled from "C:\xampp\htdocs\karir\templates\matrik_add.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:2272056fdea8bbc5763_10572149%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2231173555fb8df302df65dbc36e82490d8298a2' => 
    array (
      0 => 'C:\\xampp\\htdocs\\karir\\templates\\matrik_add.tpl',
      1 => 1459221958,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2272056fdea8bbc5763_10572149',
  'variables' => 
  array (
    'kelompokjbt_opt' => 0,
    'tingkatjbt_opt' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_56fdea8bdae6d7_84783535',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_56fdea8bdae6d7_84783535')) {
function content_56fdea8bdae6d7_84783535 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '2272056fdea8bbc5763_10572149';
	                	...
	                	<div class="row">
	                		<div class="col-md-6">
	                			<div class="form-group">
                                    ...
                                    <input type="text" name="Nama_KelompokTingkatJbt" placeholder="Nama Kelompok" class="form-control" required>
	                			</div>
	                		</div>
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['detail']['loop'] = is_array($_loop=$_smarty_tpl->tpl_vars['kelompokjbt_opt']->value) ? count($_loop) : max(0, (int) $_loop); unset($_loop);
...
?>
                                <option value="<?php echo $_smarty_tpl->tpl_vars['kelompokjbt_opt']->value[$_smarty_tpl->getVariable('smarty')->value['section']['detail']['index']]['id'];?>
" <?php echo $_smarty_tpl->tpl_vars['kelompokjbt_opt']->value[$_smarty_tpl->getVariable('smarty')->value['section']['detail']['index']]['selected'];?>
><?php echo $_smarty_tpl->tpl_vars['kelompokjbt_opt']->value[$_smarty_tpl->getVariable('smarty')->value['section']['detail']['index']]['nama'];?>
</option>
                                <?php endfor; endif; ?>
                                </select>
	                			</div>
	                		...
	                		<div class="col-md-6">
                                ...
                                <?php if (isset($_smarty_tpl->tpl_vars['smarty']->value['section']['detail'])) unset($_smarty_tpl->tpl_vars['smarty']->value['section']['detail']);
$_smarty_tpl->tpl_vars['smarty']->value['section']['detail']['name'] = 'detail';
$_smarty_tpl->tpl_vars['smarty']->value['section']['detail']['loop'] = is_array($_loop=$_smarty_tpl->tpl_vars['tingkatjbt_opt']->value) ? count($_loop) : max(0, (int) $_loop); unset($_loop);
$_smarty_tpl->tpl_vars['smarty']->value['section']['detail']['show'] = true;
$_smarty_tpl->tpl_vars['smarty']->value['section']['detail']['max'] = $_smarty_tpl->tpl_vars['smarty']->value['section']['detail']['loop'];
$_smarty_tpl->tpl_vars['smarty']->value['section']['detail']['step'] = 1;
$_smarty_tpl->tpl_vars['smarty']->value['section']['detail']['start'] = $_smarty_tpl->tpl_vars['smarty']->value['section']['detail']['step'] > 0 ? 0 : $_smarty_tpl->tpl_vars['smarty']->value['section']['detail']['loop']-1;
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['detail']['last']       = ($_smarty_tpl->tpl_vars['smarty']->value['section']['detail']['iteration'] == $_smarty_tpl->tpl_vars['smarty']->value['section']['detail']['total']);
?>
                                <option value="<?php echo $_smarty_tpl->tpl_vars['tingkatjbt_opt']->value[$_smarty_tpl->getVariable('smarty')->value['section']['detail']['index']]['id'];?>
" <?php echo $_smarty_tpl->tpl_vars['tingkatjbt_opt']->value[$_smarty_tpl->getVariable('smarty')->value['section']['detail']['index']]['selected'];?>
><?php echo $_smarty_tpl->tpl_vars['tingkatjbt_opt']->value[$_smarty_tpl->getVariable('smarty')->value['section']['detail']['index']]['nama'];?>
</option>
                                <?php endfor; endif; ?>
                                </select>
	                			</div>
