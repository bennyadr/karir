<?php /* Smarty version 3.1.27, created on 2016-02-18 08:39:50
         compiled from "C:\xampp\htdocs\sip\templates\form_cuti_edit.tpl" */ ?>
<?php
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_56c5754612a051_76791574',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_56c5754612a051_76791574')) {
function content_56c5754612a051_76791574 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '3020056c57546019167_29348412';
...
">
               ...
               <div class="form-group">
                ...
                <input type="text" autocomplete="off" onkeyup="autoComplete();" id='inputan' placeholder="Autosuggest Nama Karyawan" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['nama']->value;?>
" required>
                <input type='hidden' id='nama' name='nama' value="<?php echo $_smarty_tpl->tpl_vars['idpeg']->value;?>
">
                <div id="hasil"></div>
              </div>
              ...
              <div class="form-group">
                <label>NIK :</label>
                <input type="text" name="nip" id="nip" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['nik']->value;?>
" />
                </div>

                <div class="form-group">
                <label>Jabatan :</label>
                <input type="text" name="jabatan" id="jabatan" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['jabatan']->value;?>
" />
                </div>
                ...
                <input type="text" name="no_telp" id="no_telp" class="form-control" placeholder="No Telp/HP" value="<?php echo $_smarty_tpl->tpl_vars['notelp']->value;?>
" />
                </div>

                <div class="form-group">
                <label>Alamat Pemohon :</label> 
                <textarea type="text" name="alamat" placeholder="Alamat Pemohon" class="form-control" required><?php echo $_smarty_tpl->tpl_vars['alamat']->value;?>
</textarea>
                </div>
                ...
                <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <input type="text" autocomplete="off" onkeyup="autoComplete2();" id='inputan2' placeholder="Autosuggest Nama Atasan" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['namaats']->value;?>
" required>
                          <input type='hidden' id='nama2' name='nama2' value="<?php echo $_smarty_tpl->tpl_vars['idpeg2']->value;?>
">
                      <div id="hasil2"></div>
                      </div>
                ...
                <input type="text" name="jabatanats" id="jabatanats" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['jabatanats']->value;?>
" />
                </div>

                <div class="form-group"><label>Tanggal Mulai :</label>
                                      <input type="text" name="tgl_mulai" class="form-control input-sm" id="tgl_mulai" placeholder="dd/mm/yyyy" value="<?php echo $_smarty_tpl->tpl_vars['tgl_mulai']->value;?>
" required>
                                    </div>
...
><?php echo $_smarty_tpl->tpl_vars['jenis_cuti']->value[$_smarty_tpl->getVariable('smarty')->value['section']['detail']['index']]['nama'];?>
                ...
                <input type="text" name="jmlhari" id="jmlhari" placeholder="Hari Kerja" class="form-control" / value="<?php echo $_smarty_tpl->tpl_vars['jmlhari']->value;?>
" required></div></div>
                              </div>

                 <div class="form-group">
                <label>Alasan Pemohon :</label> 
                <textarea type="text" name="alasan" placeholder="Alasan Pemohon" class="form-control" required><?php echo $_smarty_tpl->tpl_vars['alasan']->value;?>
</textarea>
                </div>
